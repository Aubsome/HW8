...
class Pump_View():
    ...
    def DoPlot(self, Model):
        ...
        # Points from data
        headx_data = Model.FlowData
        heady_data = Model.HeadData
        effx_data = Model.FlowData  # Assuming efficiency data has same x-axis as head data
        effy_data = Model.EffData
